...
// PageEditingUsers = new Mongo.Collection("pageEditingUsers");
// PageComments = new Mongo.Collection("cyoaComments");
// PageParams = new Mongo.Collection("cyoaParams");
// set up a schema controlling the allowable 
// structure of comment objects for adventures
...
CyoaParams.allow({
	// we need to be able to update images for ratings.
	update:function(userId, doc){
		console.log("testing security on param update");
		if (Meteor.user()){// they are logged in
			if (userId != doc.owner){// the user is messing about
				return false;
			} else {// the user is logged in, the adventure has the correct user id
	...
	insert:function(userId, doc){
		console.log("testing security on param insert");
		if (Meteor.user()){// they are logged in
//			 if (userId != doc.owner){// the user is messing about
// 	return false;
//			 } else {// the user is logged in, the adventure has the correct user id
...
//			 }
	...
	remove:function(userId, doc){
		console.log("testing security on param remove");
		if (Meteor.user()){// they are logged in
			if (userId != doc.owner){// the user is messing about
				return false;
			} else {// the user is logged in, the adventure has the correct user id
