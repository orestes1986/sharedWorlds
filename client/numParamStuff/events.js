...
Template.condition_select_numvalue.events({
	"click .js-set-condition-numvalue":function(event){
...
// 			realPageBody.conditions[selectedConditionIndex].paramValueIndex = valueIndex;
            realPageBody.conditions[selectedConditionIndex].numORnot = true;
// 			console.log(realPageBody);
		}
...
// 		console.log(event);
		$("#condition_select_numvalue").modal('hide');
	},
});
